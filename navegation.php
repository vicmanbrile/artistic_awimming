<nav class="relative z-10">
    ...
    >
      ...
      <button
        id="menu-btn"
        class="md:hidden focus:outline-none focus:ring-2 focus:ring-offset-2"
      >
        <svg
    ...
    >
      <ul class="space-y-2">
        <li>
          <a href="./" class="text-xl font-bold text-gray-800 block py-2"
            >Aquart Synchro</a
          >
        </li>
        <li>
          <a href="./" class="text-gray-700 hover:text-gray-600 block py-2"
            >Inicio</a
          >
        </li>
        <li>
